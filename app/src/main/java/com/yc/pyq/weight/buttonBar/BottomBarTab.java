package com.yc.pyq.weight.buttonBar;
...
//        mIcon.setColorFilter(ContextCompat.getColor(context, R.color.tab_gray));
    ...
    public void setSelected(boolean selected) {
        ...
        switch (mTabPosition){
            case 0:
                mIcon.setImageResource(selected? R.mipmap.m01 : R.mipmap.m04);
                break;
            case 1:
                mIcon.setImageResource(selected? R.mipmap.m02 : R.mipmap.m05);
                break;
            case 2:
                mIcon.setImageResource(selected? R.mipmap.m03 : R.mipmap.m06);
                break;
        }
        if (selected) {
